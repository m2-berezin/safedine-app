-- First, let's create The Real Greek restaurant if it doesn't exist
INSERT INTO public.restaurants (name, address, location_id, image_url)
SELECT 'The Real Greek', '15 Soho Street, London W1D 3DT', l.id, 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'
FROM public.locations l 
WHERE l.name = 'London'
AND NOT EXISTS (SELECT 1 FROM public.restaurants WHERE name = 'The Real Greek')
LIMIT 1;

-- Get The Real Greek restaurant ID for menu creation
DO $$
DECLARE
...
BEGIN
    -- Get restaurant ID
    SELECT id INTO restaurant_uuid FROM public.restaurants WHERE name = 'The Real Greek' LIMIT 1;
    
    -- Create menus
    INSERT INTO public.menus (restaurant_id, name, description, display_order) VALUES
    (restaurant_uuid, 'All Day', 'Our full menu available all day', 1) RETURNING id INTO all_day_menu_uuid;
    
    INSERT INTO public.menus (restaurant_id, name, description, display_order) VALUES
    (restaurant_uuid, 'Lunch', 'Light lunch options perfect for a quick meal', 2) RETURNING id INTO lunch_menu_uuid;
    
    INSERT INTO public.menus (restaurant_id, name, description, display_order) VALUES
    (restaurant_uuid, 'Kids', 'Delicious meals for our youngest guests', 3) RETURNING id INTO kids_menu_uuid;
    
    INSERT INTO public.menus (restaurant_id, name, description, display_order) VALUES
    (restaurant_uuid, 'Drinks', 'Refreshing beverages and traditional Greek drinks', 4) RETURNING id INTO drinks_menu_uuid;
    ...
    -- Insert menu items for All Day Menu - Mezze & Starters
    ...
    -- Insert menu items for All Day Menu - Main Dishes
    ...
    -- Insert menu items for All Day Menu - Grills & Souvlaki
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories, spice_level) VALUES
    ...
    -- Insert menu items for All Day Menu - Desserts
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Lunch Menu - Light Bites
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Lunch Menu - Lunch Mains
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Kids Menu - Kids Mains
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Kids Menu - Kids Sides
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Drinks Menu - Hot Drinks
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Drinks Menu - Cold Drinks
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
    ...
    -- Insert menu items for Drinks Menu - Alcoholic Beverages
    INSERT INTO public.menu_items (category_id, name, description, price, allergens, dietary_info, is_popular, preparation_time, calories) VALUES
