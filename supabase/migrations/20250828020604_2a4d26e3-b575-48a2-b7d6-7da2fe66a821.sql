...
UNION ALL
SELECT 'Antipasti Platter', 'Selection of cured meats and cheeses', 14.95, category_id, ARRAY['D', 'MU', 'SD'], ARRAY[], 450, 5, true, true FROM antipasti_categories
UNION ALL
SELECT 'Calamari Fritti', 'Crispy fried squid with aioli', 8.95, category_id, ARRAY['M', 'G', 'E'], ARRAY[], 280, 10, false, true FROM antipasti_categories
UNION ALL
...
UNION ALL
SELECT 'Pepperoni', 'Spicy pepperoni with mozzarella', 14.95, category_id, ARRAY['G', 'D'], ARRAY[], 680, 12, true, true FROM pizza_rosse_categories
UNION ALL
SELECT 'Diavola', 'Spicy salami, chili oil, mozzarella', 15.50, category_id, ARRAY['G', 'D'], ARRAY[], 720, 12, true, true FROM pizza_rosse_categories
UNION ALL
...
UNION ALL
SELECT 'Quattro Stagioni', 'Artichokes, ham, mushrooms, olives', 16.95, category_id, ARRAY['G', 'D'], ARRAY[], 650, 15, false, true FROM pizza_rosse_categories;
...
UNION ALL
SELECT 'Prosciutto e Funghi', 'Parma ham, wild mushrooms, mozzarella', 17.50, category_id, ARRAY['G', 'D'], ARRAY[], 680, 15, true, true FROM pizza_bianche_categories
UNION ALL
...
UNION ALL
SELECT 'Express Pepperoni', 'Fast pepperoni pizza', 11.95, category_id, ARRAY['G', 'D'], ARRAY[], 580, 8, true, true FROM express_pizza_categories
UNION ALL
...
UNION ALL
SELECT 'Olives', 'Marinated Italian olives', 3.95, category_id, ARRAY[], ARRAY['V', 'VG'], 120, 2, true, true FROM sides_categories
UNION ALL
...
UNION ALL
SELECT 'Kids Pepperoni', 'Small pepperoni pizza', 8.95, category_id, ARRAY['G', 'D'], ARRAY[], 420, 10, true, true FROM kids_pizza_categories
UNION ALL
...
INSERT INTO menu_items (name, description, price, category_id, allergens, dietary_info, calories, preparation_time, is_popular, is_available)
SELECT 'Kids Apple Juice', 'Pure organic apple juice', 2.95, category_id, ARRAY[], ARRAY['V', 'VG'], 80, 1, true, true FROM kids_drinks_categories
UNION ALL
SELECT 'Kids Orange Juice', 'Freshly squeezed orange juice', 2.95, category_id, ARRAY[], ARRAY['V', 'VG'], 90, 1, true, true FROM kids_drinks_categories
UNION ALL
...
INSERT INTO menu_items (name, description, price, category_id, allergens, dietary_info, calories, preparation_time, is_popular, is_available)
SELECT 'Chianti Classico', 'Traditional Tuscan red wine', 28.00, category_id, ARRAY['SD'], ARRAY[], 0, 2, true, true FROM wine_categories
UNION ALL
SELECT 'Pinot Grigio', 'Crisp white wine from Veneto', 24.00, category_id, ARRAY['SD'], ARRAY[], 0, 2, true, true FROM wine_categories
UNION ALL
SELECT 'Prosecco', 'Italian sparkling wine', 26.00, category_id, ARRAY['SD'], ARRAY[], 0, 2, true, true FROM wine_categories
UNION ALL
SELECT 'House Red', 'Franco Manca house red blend', 19.50, category_id, ARRAY['SD'], ARRAY[], 0, 2, false, true FROM wine_categories
UNION ALL
SELECT 'House White', 'Franco Manca house white blend', 19.50, category_id, ARRAY['SD'], ARRAY[], 0, 2, false, true FROM wine_categories;
...
INSERT INTO menu_items (name, description, price, category_id, allergens, dietary_info, calories, preparation_time, is_popular, is_available)
SELECT 'Peroni', 'Classic Italian lager', 4.95, category_id, ARRAY['G'], ARRAY[], 180, 2, true, true FROM beer_categories
UNION ALL
SELECT 'Moretti', 'Premium Italian beer', 5.50, category_id, ARRAY['G'], ARRAY[], 200, 2, true, true FROM beer_categories
UNION ALL
SELECT 'Camden Hells', 'London craft lager', 5.95, category_id, ARRAY['G'], ARRAY[], 220, 2, false, true FROM beer_categories
UNION ALL
SELECT 'Aspall Cider', 'Traditional English cider', 5.50, category_id, ARRAY[], ARRAY['V', 'VG'], 180, 2, false, true FROM beer_categories;
...
INSERT INTO menu_items (name, description, price, category_id, allergens, dietary_info, calories, preparation_time, is_popular, is_available)
SELECT 'San Pellegrino', 'Italian sparkling water', 3.50, category_id, ARRAY[], ARRAY['V', 'VG'], 0, 1, true, true FROM soft_drink_categories
UNION ALL
SELECT 'Aranciata', 'Italian orange soda', 3.95, category_id, ARRAY[], ARRAY['V', 'VG'], 120, 1, true, true FROM soft_drink_categories
UNION ALL
SELECT 'Limonata', 'Italian lemon soda', 3.95, category_id, ARRAY[], ARRAY['V', 'VG'], 110, 1, false, true FROM soft_drink_categories
UNION ALL
SELECT 'Coca-Cola', 'Classic Coca-Cola', 3.50, category_id, ARRAY[], ARRAY['V', 'VG'], 140, 1, true, true FROM soft_drink_categories
UNION ALL
SELECT 'Fresh Orange Juice', 'Freshly squeezed orange juice', 4.50, category_id, ARRAY[], ARRAY['V', 'VG'], 110, 3, true, true FROM soft_drink_categories;
...
INSERT INTO menu_items (name, description, price, category_id, allergens, dietary_info, calories, preparation_time, is_popular, is_available)
SELECT 'Espresso', 'Traditional Italian coffee', 2.50, category_id, ARRAY[], ARRAY['V', 'VG'], 5, 3, true, true FROM coffee_categories
UNION ALL
SELECT 'Cappuccino', 'Espresso with steamed milk', 3.50, category_id, ARRAY['D'], ARRAY['V'], 120, 4, true, true FROM coffee_categories
UNION ALL
SELECT 'Americano', 'Espresso with hot water', 3.00, category_id, ARRAY[], ARRAY['V', 'VG'], 10, 3, true, true FROM coffee_categories
UNION ALL
SELECT 'Latte', 'Espresso with steamed milk', 3.95, category_id, ARRAY['D'], ARRAY['V'], 150, 4, true, true FROM coffee_categories
UNION ALL
SELECT 'Italian Hot Tea', 'Selection of Italian herbal teas', 2.95, category_id, ARRAY[], ARRAY['V', 'VG'], 0, 3, false, true FROM coffee_categories;